...
def get_args():
    ...
    parser.add_argument("--backbone_type", type=str, default="vit_tiny", help="backbone type for vision transformer [vit_tiny, kd_starnet_s3, kd_tinyvit_5m]")
    ...
    parser.add_argument("--img_size", type=tuple, default=(384, 128)) # default 384, 128
    ...
    # parser.add_argument("--milestones", type=int, nargs='+', default=(70, 110))
    ...
    parser.add_argument("--data_ratio", type=float, default=1.0, help="ratio of training data to use")
