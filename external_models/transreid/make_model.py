...
import copy
from .backbones.vit_pytorch import vit_base_patch16_224_TransReID, vit_small_patch16_224_TransReID,vit_tiny_patch16_224_TransReID,kd_vit_tiny_patch16_224_TransReID,kd_vit_small_patch16_224_TransReID
...
from .backbones.vision_transformer import vit_small, vit_tiny
from .backbones.tinyvit import tinyvit_5m,tinyvit_21m,kd_tinyvit_5m
...
class build_transformer(nn.Module):
    def __init__(self, num_classes, camera_num, view_num, cfg, factory, semantic_weight):
        ...
        elif 'TransReID' in cfg.MODEL.TRANSFORMER_TYPE or 'vit' in cfg.MODEL.TRANSFORMER_TYPE or 'cspnext' in cfg.MODEL.TRANSFORMER_TYPE:
            self.base = factory[cfg.MODEL.TRANSFORMER_TYPE](img_size=cfg.INPUT.SIZE_TRAIN, drop_path_rate=cfg.MODEL.DROP_PATH, drop_rate= cfg.MODEL.DROP_OUT,attn_drop_rate=cfg.MODEL.ATT_DROP_RATE)
        else:
